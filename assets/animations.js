document.addEventListener("DOMContentLoaded", function () {
  ...
  */
  ...
  if (slideUpScrollElements.length > 0) {
    gsap.from(".animate-slide-up-scroll .word", {
      y: "100%",
      opacity: 1,
      duration: 0.5,
      ease: "power1.out",
  ...
  */
  ...
  if (rotateScrollElements.length > 0) {
    gsap.from(".animate-rotate-scroll .word", {
      y: "110%",
      opacity: 1,
      rotationZ: "10",
      duration: 0.5,
  ...
  */
  ...
  if (opacityScrubElements.length > 0) {
    gsap.from(".animate-opacity-scrub-scroll .word", {
      opacity: 0.3,
      duration: 0.5,
      ease: "power1.out",
      stagger: 0.1,
  ...
  */
  if (bodyElements.length > 0) {
    gsap.from(".animate-body-slide-up-scroll", {
      y: "100%",
      opacity: 1,
      duration: 0.5,
      ease: "power1.out",
