...
async function prefetchComplementaryProducts() {
  // Get current product handle from the page URL
  ...
  try {
    ...
    // Update the slider immediately if the data is fresh
